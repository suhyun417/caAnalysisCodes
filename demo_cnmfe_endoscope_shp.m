...
% nam = '/procdata/parksh/_marmoset/invivoCalciumImaging/Tabla/20191125/_preproc/BPM_sDS_cat_RigidMC_cat.mat';
% nam = '/procdata/parksh/_marmoset/invivoCalciumImaging/Max/20191125/_preproc/BPM_sDS_cat_RigidMC_cat.mat'; % './data_1p.tif';
nam = '/procdata/parksh/_marmoset/invivoCalciumImaging/Tabla/Session/20191118/_preproc/121755_sDS_cat_c_bpf_mc.tif'; % './data_1p.tif';
cnmfe_choose_data;

%% create Source2D class object for storing results and parameters
Fs = 10;             % frame rate
ssub = 1;           % spatial downsampling factor
tsub = 4; % 1;           % temporal downsampling factor
gSig = 5; %8; %%7; %5; %3;           % width of the gaussian kernel, which can approximates the average neuron shape
gSiz = 10; %10; %13;          % maximum diameter of neurons in the image plane. larger values are preferred.
...
min_corr = 0.9; %0.8;     % minimum local correlation for a seeding pixel
min_pnr = 10; %8;       % minimum peak-to-noise ratio for a seeding pixel
...
display_merge = true; %false;          % visually check the merged neurons
...
%% save video
kt = 4; %3;     % play one frame in every kt frames
save_avi = true;
