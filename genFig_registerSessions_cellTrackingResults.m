% genFig_registerSessions_cellTrackingResults.m
%
% 2024/05/20 SHP
% visualize the longitudinal registration results
%   - a histogram of tracking duration (in sessions, days, etc.)
%   - mapping of the tracking duration to the FOV?
...
set(gca, 'TickDir', 'out', 'Box', 'off')
set(gca, 'FontSize', 15, 'LineWidth', 2)
xlabel('Maximum days between detected sessions')
ylabel('Number of cells')
% print(gcf, fullfile(dirFig, sprintf('%s_FOV%d_cellRegistration_histogram_days', nameSubj, FOV_ID)), ...
%     '-r300', '-depsc')
