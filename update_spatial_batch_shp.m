function update_spatial_batch_shp(obj, use_parallel)
...
% SHP added new "post_process_spatial_shp" in line 35
...
obj.post_process_spatial_shp();  %obj.post_process_spatial(); 
