...
scale = 3.125;
res_PC1 = analyze_functional_axis(x, y, PC1, scale);
res_PC2 = analyze_functional_axis(x, y, PC2, scale);
res_PC3 = analyze_functional_axis(x, y, PC3, scale);


fprintf('PC1 x-axis: lambda = %.1f um, Power = %.1f\n', res_PC1.x.lambda, res_PC1.x.power)
fprintf('PC1 y-axis: lambda = %.1f um, Power = %.1f\n', res_PC1.y.lambda, res_PC1.y.power)
fprintf('PC2 x-axis: lambda = %.1f um, Power = %.1f\n', res_PC2.x.lambda, res_PC2.x.power)
fprintf('PC2 y-axis: lambda = %.1f um, Power = %.1f\n', res_PC2.y.lambda, res_PC2.y.power)
