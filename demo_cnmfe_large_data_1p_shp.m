...
% nam = get_fullname('/procdata/parksh/_marmoset/invivoCalciumImaging/Tabla/Session/20191118/_preproc/121755_sDS_cat_c_bpf_mc.tif');
% nam = get_fullname('/procdata/parksh/_marmoset/invivoCalciumImaging/Tabla/Session/20191118/_preproc/122607_sDS_cat_c_bpf_mc.tif');
nam = get_fullname('/procdata/parksh/_marmoset/invivoCalciumImaging/Tabla/Session/20191118/_preproc/122924_sDS_cat_c_bpf_mc.tif');
...
% -------------------------      TEMPORAL     -------------------------  %
Fs = 10;             % frame rate
tsub = 2; %1;           % temporal downsampling factor
deconv_flag = false; %true;     % run deconvolution or not 
...
% -------------------------      MERGING      -------------------------  %
show_merge = true; %false;  % if true, manually verify the merging step
...
min_pnr = 15; %8;       % minimum peak-to-noise ratio for a seeding pixel
...
neuron.merge_neurons_dist_corr(show_merge); % should put in merge_thr (the default value is 0.7 for temporal corr)
