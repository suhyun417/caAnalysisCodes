...
for iSession = 2:length(setDateSession)
...
dirPreproc_SE = fullfile(dirProcdata_session, '_preproc', 'ConcatRuns_all_source_extraction');
...
movefile(fullfile(dirPreproc_SE, '*.tif'), fullfile(dirPreproc_SE, '_critCn0p9_critPNR0p9'))
